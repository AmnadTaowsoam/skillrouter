# SkillRouter Backend Implementation Specification
...
- Database: PostgreSQL for skills, policies, routes, traces, feedback.
- Queue: Route evaluation and trace analysis jobs.
...
- workspace_id
- name
- domain: 'skill/tool/agent routing'
- status
- owner_user_id
- metadata_json
- created_at
...
1. Create project for skill/tool/agent routing.
...
- Worker can complete the primary skill/tool/agent routing workflow using sample inputs.
