# SkillRouter Environment And Configuration
...
PORT=4314
DATABASE_URL=postgresql://postgres:postgres@localhost:5432/skillrouter
APP_BASE_URL=http://localhost:4314
...
OBJECT_STORAGE_BUCKET=skillrouter-artifacts
GITHUB_TOKEN=
OPENAI_API_KEY=
ANTHROPIC_API_KEY=
SENTRY_DSN=
