# SkillRouter Clone-And-Run Quickstart
...
~~~bash
git clone https://github.com/AmnadTaowsoam/skillrouter.git
cd skillrouter
cp .env.example .env
pnpm install
pnpm dev
...
Change 'PORT' in '.env' or stop the process using port '4314'.
